...
const MovieDetails = () => {
    ...
    const { data: movie, loading } = useFetch(() =>
        fetchMovieDetail({ id: id as string }));
    ...
    return (
        <View className="bg-primary flex-1">
            <ScrollView contentContainerStyle={{
                ...
                <View>
                    <Image className="w-full h-[550px]" resizeMode="stretch"
            ...
            >
                <Image
                    className="size-5 mr-1 mt-0.5 rotate-180" tintColor="#fff" source={icons.arrow}
                />
